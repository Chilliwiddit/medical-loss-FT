...
train_batch_size=1
eval_batch_size=8
output_dir="/kaggle/working/llama3.1-8B-LoRA-pyTorch"
repo_id = "Chilliwiddit/llama3.1-8B-LoRA-pyTorch"
hf_token = ""  
...
final_output_dir = "/kaggle/working/llama3.1-8B-LoRA-pyTorch-Final"
